...
const AddCar: React.FC<AddCarProps> = ({ token }) => {
  ...
  return (
    <div className='bg-slate-800 border border-slate-400 rounded-md p-24 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 relative'>
        <h2 className='text-4xl text-white font-bold text-center mb-6'>Add New Car</h2>
        ...
        <Button className='w-full mb-4 text-[18px] mt-6 rounded-full py-2' type="submit">Add Car</Button>
        </div>
      </form>
    </div>
  );
